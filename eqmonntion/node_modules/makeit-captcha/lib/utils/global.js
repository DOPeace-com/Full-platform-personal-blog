...
exports.default = exports.MI_POWERED = exports.MI_AVATAT = exports.$g = void 0;
...
var $g = (0, _vue.reactive)({
  ...
  socialites: {
    ...
    items: [{
      name: 'github',
      icon: _iconsVue.GithubOutlined
    }, {
      name: 'weibo',
      icon: _iconsVue.WeiboCircleOutlined
    }, {
      name: 'qq',
      icon: _iconsVue.QqOutlined
    }, {
      name: 'google',
      icon: _iconsVue.GoogleOutlined
    }]
  },
  ...
  menus: {
    ...
    dropdown: [{
      ...
      icon: _iconsVue.AppstoreAddOutlined,
      tag: {
        icon: _iconsVue.FireFilled
      }
    }],
    relationshipChain: [],
    width: 256
