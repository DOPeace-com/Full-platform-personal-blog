...
_axios.default.defaults.headers.common['Content-Type'] = 'application/json;charset=UTF-8;';
/**
...
var MiRequest = /*#__PURE__*/function () {
  function MiRequest() {
    _classCallCheck(this, MiRequest);
  ...
  _createClass(MiRequest, [{
    ...
    value: function register() {
      ...
      methods.forEach(function (method) {
        ...
        this.instance[method.toLowerCase()] = function (url) {
          ...
          var configuration = _objectSpread(_objectSpread({}, args), config);
    ...
    key: "send",
    value: function () {
      var _send = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(config) {
        var _this3 = this;
