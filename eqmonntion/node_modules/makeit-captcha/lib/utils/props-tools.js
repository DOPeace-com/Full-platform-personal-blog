...
exports.tuple = exports.splitAttrs = exports.isEmptyElement = exports.initProps = exports.getSlotContent = exports.getSlot = exports.getPropSlot = exports.getPrefixCls = exports.getEvents = exports.flattenChildren = void 0;
...
var isEmptyElement = function isEmptyElement(elem) {
  ...
  return elem.type === _vue.Comment || elem.type === _vue.Fragment && elem.children.length === 0 || elem.type === _vue.Text && elem.children.trim() == '';
}.bind(void 0);
...
var flattenChildren = function flattenChildren() {
  ...
  children.forEach(function (child) {
    ...
    } else if (child && (0, _vue.isVNode)(child) && !isEmptyElement(child)) {
      res.push(child);
    } else if (_tools.$tools.isValid(child)) {
      res.push(child);
    }
  }.bind(this));
  return res;
...
var getSlot = function getSlot(instance) {
  ...
  if ((0, _vue.isVNode)(instance)) {
    if (instance.type === _vue.Fragment) {
...
exports.getPropSlot = getPropSlot;
