...
exports.default = exports.captchaModalProps = void 0;
...
var _propsTypes = _interopRequireDefault(require("../utils/props-types"));

var _propsTools = require("../utils/props-tools");
...
var captchaModalProps = function captchaModalProps() {
  ...
  return {
    prefixCls: _propsTypes.default.string,
    show: _propsTypes.default.bool.def(false),
    image: _propsTypes.default.string,
    position: _propsTypes.default.object,
    mask: _propsTypes.default.bool.def(true),
    maskClosable: _propsTypes.default.bool.def(true),
    themeColor: _propsTypes.default.string,
    bgColor: _propsTypes.default.string,
    boxShadow: _propsTypes.default.bool.def(true),
    boxShadowColor: _propsTypes.default.string,
    boxShadowBlur: _propsTypes.default.number.def(6),
    maxTries: _propsTypes.default.number.def(5),
    verifyParams: _propsTypes.default.object.def({}),
    verifyMethod: _propsTypes.default.string.def('post'),
    verifyAction: _propsTypes.default.string
  };
}.bind(void 0);

exports.captchaModalProps = captchaModalProps;
...
var _default2 = (0, _vue.defineComponent)({
  ...
  setup: function setup(props, _ref) {
    ...
    var emit = _ref.emit;
    var prefixCls = (0, _propsTools.getPrefixCls)('captcha-modal', props.prefixCls);
    var langCls = (0, _propsTools.getPrefixCls)("lang-zh-cn", props.prefixCls);
    var animation = (0, _propsTools.getPrefixCls)('anim-scale');
    var modalRef = (0, _vue.ref)(null);
    var maskRef = (0, _vue.ref)(null);
    var contentRef = (0, _vue.ref)(null);
    var sliderRef = (0, _vue.ref)(null);
    var sliderBtnRef = (0, _vue.ref)(null);
    var imageRef = (0, _vue.ref)(null);
    var blockRef = (0, _vue.ref)(null);
    var resultRef = (0, _vue.ref)(null);
    var show = (0, _vue.ref)(props.show);
    var classes = {
      modal: prefixCls,
    ...
    (0, _vue.onBeforeUnmount)(function () {
      ...
      _tools.$tools.off(params.elements.slider, 'pointerdown', dragStart);

      _tools.$tools.off(params.elements.slider, 'touchstart', dragStart);

      _tools.$tools.off(params.elements.slider, 'pointermove', dragMoving);

      _tools.$tools.off(params.elements.slider, 'touchmove', dragMoving);

      _tools.$tools.off(params.elements.slider, 'pointerup', dragEnd);

      _tools.$tools.off(params.elements.slider, 'touchend', dragEnd);
    }.bind(this));
    ...
    var initModal = function initModal() {
      ...
      _tools.$tools.on(params.elements.slider, 'pointerdown', dragStart);

      _tools.$tools.on(params.elements.slider, 'touchstart', dragStart);

      _tools.$tools.on(params.elements.slider, 'pointermove', dragMoving);

      _tools.$tools.on(params.elements.slider, 'touchmove', dragMoving);

      _tools.$tools.on(params.elements.slider, 'pointerup', dragEnd);

      _tools.$tools.on(params.elements.slider, 'touchend', dragEnd);
    }.bind(this);
    ...
    var initCaptcha = function initCaptcha() {
      ...
      if (_global.$g.regExp.url.test(params._background)) image2Base64(initImageElem);else initImageElem();
    }.bind(this);
    ...
    var drawBlockPosition = function drawBlockPosition() {
      ...
      var x = _tools.$tools.randomNumberInRange(params.block.real + 20, params.size.width - (params.block.real + 20));

      var y = _tools.$tools.randomNumberInRange(55, params.size.height - 55);
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 3:
                ...
                _context.next = 12;
                return _request.$request[props.verifyMethod.toLowerCase()](props.verifyAction, props.verifyParams).then(function (res) {
              ...
              case 19:
                ...
                setTimeout(function () {
                  ...
                  if (result) result.style.bottom = _tools.$tools.convert2Rem(-32);
                }.bind(this), 1000);
                setTimeout(function () {
                  _newArrowCheck(this, _this8);
    ...
    var renderMask = function renderMask() {
      ...
      return props.mask && props.show ? (0, _vue.createVNode)("div", {
        "class": classes.mask,
        "onClick": closeModal,
        "ref": maskRef
      }, null) : null;
    ...
    var renderContent = function renderContent() {
      ...
      var style = {
        ...
        boxShadow: props.boxShadow && (props.boxShadowColor || props.themeColor) ? "0 0 ".concat(_tools.$tools.convert2Rem(props.boxShadowBlur), " ").concat(props.boxShadowColor || props.themeColor) : null
      };
      return (0, _vue.createVNode)("div", {
      ...
      }, [renderContentLoading(), renderContentInfo(), renderContentResult()]), (0, _vue.createVNode)("div", {
        "ref": sliderRef,
        "class": "".concat(classes.slider).concat(params.drag.moving ? " ".concat(classes.slider, "-moving") : '')
      }, [renderSliderTrack(), renderSliderBtn()])]), (0, _vue.createVNode)("div", {
    ...
    var renderContentLoading = function renderContentLoading() {
      ...
      return params.loading ? (0, _vue.createVNode)("div", {
        "class": loadingCls
      }, [(0, _vue.createVNode)("div", {
        "class": "".concat(loadingCls, "-spinner")
      }, [(0, _vue.createVNode)("div", {
        "class": "load"
      }, [(0, _vue.createVNode)("div", null, [(0, _vue.createVNode)("div", null, [(0, _vue.createVNode)("div", {
        "style": style1
      }, null), (0, _vue.createVNode)("div", {
        "style": style2
      }, null)])])])]), (0, _vue.createVNode)("div", {
    ...
    var renderContentInfo = function renderContentInfo() {
      ...
      return (0, _vue.createVNode)("div", {
        ...
        "ref": imageRef
      }, null), (0, _vue.createVNode)("canvas", {
        "width": params.size.width,
        "height": params.size.height,
        "ref": blockRef
      }, null)]);
    ...
    var renderSliderTrack = function renderSliderTrack() {
      ...
      }, [(0, _vue.createTextVNode)("\u62D6\u52A8\u5DE6\u8FB9\u6ED1\u5757\u5B8C\u6210\u4E0A\u65B9\u62FC\u56FE")])]);
    }.bind(this);
    ...
    var renderPanelAction = function renderPanelAction() {
      ...
      return (0, _vue.createVNode)("div", {
      ...
      }, [(0, _vue.createVNode)(_antDesignVue.Tooltip, {
        "title": "关闭验证",
        ...
        default: function _default() {
          ...
          return [(0, _vue.createVNode)(_iconsVue.CloseCircleOutlined, {
            "onClick": closeModal
          }, null)];
        }.bind(this)
      }), (0, _vue.createVNode)(_antDesignVue.Tooltip, {
        ...
        default: function _default() {
          ...
          return [(0, _vue.createVNode)(_iconsVue.ReloadOutlined, {
        ...
        default: function _default() {
          ...
          return [(0, _vue.createVNode)("a", {
            "href": params.target,
            "target": "_blank"
          }, [(0, _vue.createVNode)(_iconsVue.QuestionCircleOutlined, null, null)])];
        }.bind(this)
      })]);
    }.bind(this);
    ...
    var renderPanelCopyright = function renderPanelCopyright() {
      ...
      return (0, _vue.createVNode)("div", {
        ...
        "src": params.avatar,
        "alt": params.powered
      }, null)]), (0, _vue.createVNode)("span", null, [(0, _vue.createTextVNode)("\u63D0\u4F9B\u6280\u672F\u652F\u6301")])])]);
    }.bind(this);
    ...
    return function () {
      ...
      return (0, _vue.createVNode)(_vue.Fragment, null, [renderMask(), (0, _vue.createVNode)(_vue.Transition, {
        "name": animation,
        "appear": true
      }, {
        default: function _default() {
          ...
          return [(0, _vue.withDirectives)((0, _vue.createVNode)("div", {
            ...
            "style": {
              top: "".concat(_tools.$tools.convert2Rem(props.position.top)),
              left: "".concat(_tools.$tools.convert2Rem(props.position.left))
            },
            "ref": modalRef
          }, [renderArrow(), renderContent()]), [[_vue.vShow, show.value]])];
        }.bind(this)
      })]);
    }.bind(this);
  }
